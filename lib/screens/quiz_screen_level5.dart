...
class QuizScreenLevel5 extends StatefulWidget {
  const QuizScreenLevel5({super.key});

  @override
  State<QuizScreenLevel5> createState() => _QuizScreenLevel5State();
}

class _QuizScreenLevel5State extends State<QuizScreenLevel5> {
  ...
  void checkAnswer(String answer) {
    setState(() {
      ...
      isCorrect = (answer == "Grilled chicken with vegetables");
    });
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  "Which meal is best for a balanced diet?",
                  style: TextStyle(
                    fontSize: 22,
